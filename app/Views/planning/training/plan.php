    ...
    <div class="card bcard">
        <div class="card-header">
            <h3 class="card-title text-125">
                ...
                <small class="text-danger"> (ตรวจสอบแผน)</small>
            </h3>
        </div>
        ...
        <div class="card-body px-3 pb-1">
            <form class="mt-lg-3" autocomplete="off" id="update-training-form" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control train-hospcode" id="train-hospcode" value="<?= view_cell('\App\Models\UserModel::getUsername', ['data' => $trainingInfo['hospcode']]); ?>" autocomplete="off">
                ...
                <hr class="border-dotted">
                <p class="text-100 text-warning">
                    <i class="fas fa-info-circle"></i> แผนงาน ผลผลิต กิจกรรม โครงการ
                </p>

                <div class="form-group row">
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <label for="train-plan" class="mb-0">
                            แผนงาน :
                        </label>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <select class="chosen-select form-control train-plan" id="train-plan" name="plan">
                ...
                <div class="form-group row">
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <label for="train-product" class="mb-0">
                            ผลผลิต :
                        </label>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <select class="form-control train-product" id="train-product" name="product">
                                <option value="">-- กรุณาเลือก --</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <label for="train-activity" class="mb-0">
                            กิจกรรม :
                        </label>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <select class="form-control train-activity" id="train-activity" name="activity">
                                <option value="">-- กรุณาเลือก --</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <label for="train-program" class="mb-0">
                            โครงการ :
                        </label>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <select class="form-control train-program" id="train-program" name="program">
                                <option value="">-- กรุณาเลือก --</option>
                            </select>
                        </div>
                    </div>
