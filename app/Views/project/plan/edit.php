<div class="modal fade" id="edit-plan" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    <div class="modal-dialog" role="document">
        <form id="edit-plan-form" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body" id="render-edit-plan">
                    <div class="text-center"><i class="fa fa-spinner fa-pulse fa-5x fa-fw"></i></div>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-info btn-round" data-adduserid="" id="edit-plan"><i class="far fa-save text-120 mr-1"></i> บันทึก</button>
