...
<div role="main" class="container-plus">
    ...
    <div class="card bcard">
        ...
        <div class="card-body px-3 pb-1">
            <form class="mt-lg-3" autocomplete="off" id="hr-transfer-form" method="post">
                <fieldset disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3">
                            <label for="input-province">
                                <strong><U>จังหวัด</U></strong>
                            </label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-address-book"></i></span>
                                </div>
                                <select class="form-control input-province" id="input-province" name="province">
                                    <option value="">-- กรุณาเลือก --</option>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-6 col-lg-3">
                            <label for="input-mobile">
                                <strong><U>เบอร์โทรศัพท์</U></strong>
                            </label>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <label for="retire">
                            <strong><U>ประเภทการจำหน่าย</U></strong><small class="text-brown"> *</small>
                        </label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                            </div>
                            <select class="chosen-select form-control input-retire" id="retire" name="retire">
                                <option value="">-- กรุณาเลือก --</option>
                                <?php foreach ($retire as $row) : ?>
                                    <option value="<?= $row->retire_id ?>"><?= $row->retire_name ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <label for="input-retireDate">
                            <strong><U>วันที่จำหน่าย</U></strong><small class="text-brown"> *</small>
                        </label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                            </div>
                            <input type="text" class="form-control input-retireDate" id="retireDate" name="retireDate" >
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <label for="input-retireDetail">
                            <strong><U>หมายเหตุ</U></strong><small class="text-brown"> *</small>
                        </label>
                        <textarea name="retireDetail" id="retireDetail" class="form-control input-retireDetail"></textarea>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <label for="input-attachment">
                            <strong><U>เอกสารแนบ</U></strong><small class="text-brown"> *</small>
                        </label>
                        <input type="file" name="attachment" class="form-control input-attachment" id="attachment">
                    </div>
                ...
                <div class="mt-5 border-t-1 brc-secondary-l2 py-35 mx-n25">
                    <div class="text-center">
                        <button type="button" id="transfer-submit" class="btn btn-info border-2 brc-black-tp10 radius-round px-3 mb-1">
