<div class="modal fade" id="add-allowance" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        ...
        <form id="add-allowance-form" method="post">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info btn-round" data-addId="" id="add-allowance"><i class="far fa-save text-120 mr-1"></i> บันทึก</button>
