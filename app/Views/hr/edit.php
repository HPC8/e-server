            ...
            <form class="mt-lg-3" autocomplete="off" id="hr-edit-form" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-cid" id="input-cid" name="cid" value="<?php echo $userInfo['cid']; ?>" disabled />
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <textarea name="hrNote" id="hrNote" class="form-control input-hrNote"><?php echo $userInfo['note']; ?></textarea>
                    </div>
